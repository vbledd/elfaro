...
function construirNoticias(categoria,titular) {
    ...
    if(categoria == 'inicio'){
        ...
        indiceAleatorio.map(indice =>{
            ...
            <table>
                <tr>
                    <th><h1>${noticias[indice].titulo}</h1></th>
                </tr>
                <tr>
                    <td>Categoria: ${noticias[indice].categoria}</td>
                </tr>
                <tr>
                    <td><img src="${noticias[indice].imagen}" width="80%"></td>
                </tr>
                <tr>
                    <td><p>${noticias[indice].descripcion}</p></td>
                </tr>
            </table>`;
        ...
        noticias.map(articulo =>{
            if(articulo.categoria == categoria){
                ...
                <table>
                    <tr>
                        <th><h1>${articulo.titulo}</h1></th>
                    </tr>
                    <tr>
                        <td>Categoria: ${articulo.categoria}</td>
                    </tr>
                    <tr>
                        <td><img src="${articulo.imagen}" width="80%"></td>
                    </tr>
                    <tr>
                        <td><p>${articulo.descripcion}</p></td>
                    </tr>
                </table>`;
...
function abrirVentana(){
    ...
    agregar = window.open('./agregarNoticia.html', '_blank','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width='+w+', height='+h+', top='+top+', left='+left);
}
